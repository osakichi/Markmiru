...
- **明示的な改ページとダーク系スタイルの印刷配色（2026-09-25 の追加）は Windows・Linux で実機検証済み、macOS は未確認**（Linux は 2026-09-26。Ubuntu 24.04・WebKitGTK 4.1・正式ビルド `1b8e1b3`）。詳細は `docs/アーキテクチャ・画面設計.md` §5.5「PDF 出力 / 印刷」および `docs/スタイル設定設計.md` §5.2 を参照
